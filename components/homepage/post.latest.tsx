...
export default function LatestPosts() {
  ...
  return (
    <Block
      className="homepage--latest-posts width-full"
    >
      <Heading as="h2" className="homepage--latest-posts__heading center mb-16" headingSize={2}>Latest posts</Heading>
      <div className="homepage--latest-posts__posts post-card__grid-container">
