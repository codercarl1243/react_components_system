...
export default function Section6() {
    ...
    return (
        <PostSection id="accessibility">
            ...
            <p>
                WCAG&apos;s four principles <span className="italic">( collectively known as <span className="bold">POUR</span> )</span> give us the foundation:
            </p>
            <Picture
            ...
            />
            <p>
                But meeting the minimum isn&apos;t the goal. As developers, our job is to design buttons that feel consistent, predictable, and inclusive in real-world situations—not just on paper.
            </p>
            <List variant="none" spacing="loose">
                <li>
